...
def portfolio_post(request,year,month,day,seotitle):
    ...
    return render(request,'portfolio/portfolio_post.html',{'post':post})
...
def manage(request,pk=''):
    ...
    if request.method == 'POST':
        ...
        return render(request,'portfolio/create.html',{'error':error,'form':form,'pk':pk})
    else:
